...
<img src="cartesian-coord-1.png" height="500" width="700" class="center"> 
...
.right-plot[
```{r plot34-out, ref.label="plot34", echo=FALSE, out.width="100%", fig.align='right'}
```
]
...
.right-plot[
```{r plot36-out, ref.label="plot36", echo=FALSE, out.width="100%", fig.align='right'}
```
]
